...
class Plot extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return dataChanged || scaleChanged || optionsChanged;
  }
  ...
  genDist(data) {
    ...
    return (
      ...
      >
        <XAxis label="x" dataKey="x" />
        <YAxis label={this.props.xlabel + ' distribution'} dataKey="y" />
        <CartesianGrid />
        <Tooltip />
      ...
      <div className="plots">
        ...
        <div className="scatter">
          ...
          >
            ...
            />
            <Tooltip />
            <Legend onClick={this.handleLegendClick.bind(this)} />
          </ScatterChart>
        </div>
        {/* y-axis distribution */}
